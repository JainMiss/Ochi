      ...
      <div className="w-1/2 ">
        ...
        <div className="flex  font-medium p-5">
          <div className=" w-1/2 dets font-['Neue_Montreal'] mt-10">
            ...
            >
              <img
                src="https://cdn.icon-icons.com/icons2/285/PNG/96/social_facebook_box_blue_256_30649.png"
                alt=""
            ...
            >
              <img
                src="https://img.icons8.com/?size=48&id=FPVfLTn66dUC&format=gif"
                alt=""
                className="w-[50px] h-[50px]"
              />
              Instagram
            ...
            >
              <img
                src="https://cdn-icons-png.freepik.com/256/3670/3670151.png?ga=GA1.1.11225884.1712565480&semt=ais_hybrid"
                alt=""
                className="w-[50px] h-[50px]"
              />
              Twitter
          ...
          <div className="w-1/2 dets font-['Neue_Montreal'] mt-10">
            ...
            >
              <img
                src="https://img.icons8.com/?size=64&id=118979&format=png"
                alt=""
                className="w-[50px] h-[50px]"
              />
              LinkedIn
            ...
            <br />
            <a className=" block text-sm font-light" href="https://github.com/">
              <img
