    ...
    <div data-scroll data-scroll-section className="relative w-full py-20 ">
      ...
      <div className="px-20">
        <div className="cards  w-full flex  gap-10 mt-10">
          ...
          >
            <h1 className="absolute  flex text-[#CDEA68] left-full  overflow-hidden  -translate-x-1/2 top-1/2 -translate-y-1/2  z-[9]  leading-none  tracking-tighter text-8xl ">
            ...
            <div className="card  w-full h-full rounded-xl overflow-hidden">
              <img
                className=" w-full h-ull bg-cover "
