...
function About() {
  return (
    <div className=" w-full p-10 h-full   bg-[#CDEA68] rounded-tl-3xl rounded-tr-3xl text-black">
      ...
      <div className="w-full flex flex-wrap sm:flex-nowrap gap-5  border-t-[1px] mt-20 pt-10 border-[#7e9c11]">
        <div className="w-full ">
                  <h1 className="text-4xl lg:text-6xl xl:text-8xl">Our approch :</h1>
                  <button className="  uppercase flex gap-10 items-center px-6  mt-10 py-3 bg-zinc-900 rounded-full text-white xl:text-4xl">Read more
