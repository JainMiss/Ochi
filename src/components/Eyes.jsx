    ...
    <div className="eyes  w-full h-screen  overflow-hidden ">
      <div  data-scroll data-scroll-speed="-.7" className=' relative w-full h-full  bg-cover bg-center  bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg")] '>
        <div className="absolute flex  gap-10 top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]    ">
          <div className=" flex items-center justify-center w-[30vw] h-[30vw] rounded-full bg-zinc-100 ">
            ...
            <div className="   relative  w-2/3 h-2/3 rounded-full bg-zinc-900">
              <div
                ...
                className="line  absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] w-full rotate   h-10"
              >
